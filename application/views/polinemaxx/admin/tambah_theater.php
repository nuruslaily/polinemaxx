    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800"><i class="fas fa-fw fa-plus"></i> Tambah Theater </h1><br>
                          ...
                          <table class="table table-borderless" align="center" style="color: black">
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>:</td>
                                <td><input name="telp" id="telp" type="text" size="20" maxlength="20"></td>
                              </tr>
                              <tr>
                                <td class="text-right">Bioskop</td>
                                <td>:</td>
                                <td><input name="bioskop" id="bioskop" type="text" size="30"></td>
                              </tr>
                              <tr>
