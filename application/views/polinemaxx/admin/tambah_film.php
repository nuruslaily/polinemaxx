      ...
      <li class="nav-item open active">
        ...
        <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="<?php echo base_url(); ?>polinemaxx/admin/tambah_film"><i class="fas fa-fw fa-plus" aria-hidden="true"></i>Tambah Movie</a>
          </div>
        </div>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800"><i class="fas fa-fw fa-plus"></i> Tambah Movie</h1><br>

          <?php form_open('admin/insert_film'); ?>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                  <table class="table table-bordered" width="70%" cellspacing="0" style="color: black">
                    ...
                    <tr>
                      <th>Dimensi </th>
                      <td>:</td>
                      <td><input type="radio"  name="dimensi" id="2d" value="2D">2D
                          <input type="radio"  name="dimensi" id="3d" value="3D">3D</td>
                    </tr>
                    <tr>
                      <th>Usia </th>
                      <td>:</td>
                      <td><input type="text" name="usia" id="usia" size="5"></td>
                    </tr>
                    <tr>
                      <th>Trailer</th>
                      <td>:</td>
                      <td><input type="file" class="form-control" name="trailer" id="trailer"></td>
                    </tr>
                    <tr>
                      <th>Judul</th>
                      <td>:</td>
                    ...
                    <tr>
                      <th>Kategori</th>
                      <td>:</td>
                      <td><input type="text" class="form-contro-l" name="kategori" id="kategori"></td>
                    </tr>
                    <tr>
                      <th>Durasi</th>
                      <td>:</td>
                      <td><input type="time" class="form-control" name="durasi" id="durasi"></td>
                    </tr>
                    <tr>
                      <th>Produser</th>
                      <td>:</td>
                      <td><input type="text" class="form-control" name="produser" id="produser"></td>
                    </tr>
                    <tr>
                      <th>Direktor</th>
                      <td>:</td>
                      <td><input type="text" class="form-control" name="direktor" id="direktor"></td>
                    </tr>
                    <tr>
                      <th>Penulis</th>
                      <td>:</td>
                    ...
                    <tr>
                      <th>Cast</th>
                      <td>:</td>
                      <td><textarea class="form-control" name="cast" id="cast"></textarea></td>
                    </tr>
                    <tr>
                      <th>Deskripsi</th>
                      <td>:</td>
