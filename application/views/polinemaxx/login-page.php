...
<header>
    ...
    <?=
    form_open('polinemaxx/proses_login');
    ?>
                ...
                <div class="login-form">
                    ...
                    <form>
                        ...
                        <div class="pom-agile">
                            ...
                            <input placeholder="Kata Sandi" name="password" class="pass" type="password" required="">
                        </div>
                    </form><br>
                    <button class="inlog-btn">Login</button>
                    <h4>Belum punya akun? <a href="<?php echo base_url();?>polinemaxx/daftar">Buat sekarang!</a></h4>
                </div>
            </div>
        </div>
    </section>
